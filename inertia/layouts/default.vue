...
<template>
      ...
      <div>
        <nav>
          <template v-if="page.props.user">
            <Link route="proxies.index">Proxies</Link>
            <Link v-if="page.props.user.role === 'superadmin'" route="licenses.index">Licenses</Link>
  ...
  <div
    class="min-h-screen overflow-auto antialiased bg-background text-neutral-900 dark:text-neutral-50"
  >
    <slot />
    <GlobalAlert />
