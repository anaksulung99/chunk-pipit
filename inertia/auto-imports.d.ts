...
declare global {
  ...
  const theme: typeof import('./lib/theme').default
  ...
  const useFacebookAccount: typeof import('./composables/useFacebookAccount').useFacebookAccount
  const useFacebookProfile: typeof import('./composables/useFacebookProfile').useFacebookProfile
  ...
  const useProxyHealthCheck: typeof import('./composables/useProxyHealthCheck').useProxyHealthCheck
...
declare global {
  ...
  // @ts-ignore
  export type { TableOrder, TableMeta } from './composables/useDataTable'
  import('./composables/useDataTable')
  // @ts-ignore
  export type { SelectionPayload } from './composables/useTableSelection'
  import('./composables/useTableSelection')
  // @ts-ignore
  export type { AdminNavItem } from './types/index.d'
  ...
  import('./utils/time')
  // @ts-ignore
  export type { ButtonVariants } from './lib/utils'
  import('./lib/utils')
}
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly theme: UnwrapRef<typeof import('./lib/theme')['default']>
    ...
    readonly useFacebookAccount: UnwrapRef<typeof import('./composables/useFacebookAccount')['useFacebookAccount']>
    ...
    readonly useProxyHealthCheck: UnwrapRef<typeof import('./composables/useProxyHealthCheck')['useProxyHealthCheck']>
